...
class foreman_proxy (
  ...
  Array[String] $groups = $foreman_proxy::params::empty_array,
  ...
  Array[String] $ssl_disabled_ciphers = $foreman_proxy::params::empty_array,
  Array[String] $tls_disabled_versions = $foreman_proxy::params::empty_array,
  ...
  Array[String] $dhcp_subnets = $foreman_proxy::params::empty_array,
  ...
  Array[String] $dhcp_additional_interfaces = $foreman_proxy::params::empty_array,
  ...
  Array[String] $dns_forwarders = $foreman_proxy::params::empty_array,
